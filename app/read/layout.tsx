  ...
  return (
    <>
      ...
      >
        ...
        >
          Launched best Saas Marketing template at cheap — <span className="underline">Check out</span>
        </Link>{' '}
      </Banner>
        ...
        <div className="min-h-screen" vaul-drawer-wrapper="">
          <div className="absolute inset-0 -z-10 mx-0 max-w-none overflow-hidden">
            <div className="absolute top-0 left-1/2 ml-[-30rem] h-[27rem] w-[85rem] dark:[mask-image:linear-gradient(white,transparent)]">
              <div className="absolute inset-0 bg-gradient-to-r from-[#1e3a8a] to-[#60a5fa] [mask-image:radial-gradient(farthest-side_at_top,white,transparent)] opacity-40 dark:from-[#1e3a8a]/30 dark:to-[#60a5fa]/30 dark:opacity-100">
                <svg
                  aria-hidden="true"
                    ...
                    icon: (
                      <div
                        ...
                        style={{
                          ...
                          backgroundColor: `hsl(var(--${meta}-color)/.3)`,
                        }}
                      >
                        {node.icon}
                      </div>
